...
import type { CloudinaryResponseType } from "../app/pages/Account/types/cloudinaryResponseType";
...
declare global {
    ...
    type UserInfo = {
        ...
        email: string,
        password: string,
        photoData?: CloudinaryResponseType
        userName?: string
    }
    ...
    type MessagesUi = {
        role: "user" | "model";
        message: string;
        attachments?: FileAttachment[] | TaskAttachment[];
        replyTo?: string;
        bookMarked?: boolean;
        chatId?: string;
        convoId?: string; 
    ...
    type TaskAttachment = BaseAttachment & Task
...
declare global {
    type Context = {
        ...
        analytics: Analytics, setAnalytics: Dispatch<SetStateAction<Analytics>>
        weekData: AnalyticsWeekData | null, setWeekData: Dispatch<SetStateAction<AnalyticsWeekData | null>>
