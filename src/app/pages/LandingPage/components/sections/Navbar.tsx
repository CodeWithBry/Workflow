...
function Navbar() {
  ...
  const userData: UserData | null = getFromLocalStorage ? JSON.parse(getFromLocalStorage) : null;
    ...
    <>
      <nav className={`${styles.nav}${scrolled ? ` ${styles.scrolled}` : ""}`}>
        ...
        <div className={styles.navActions}>
          <LinkTag to={"/activities"} variant="ghost" content={userData ? "Go to projects" : "Sign In"} />
      ...
      >
        ...
        <div className={styles.mobileCtas}>
          <LinkTag to={"/login"} variant="outline" content={userData ? "Go to projects" : "Sign In"} clickListener={close} />
