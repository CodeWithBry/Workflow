...
function ActivitiesTools() {
    const { taskClass, setTaskClass, selectedTaskClass, navigation, historyChanges, setHistoryChanges, allowChanges, setAllowChanges, isDataLoaded, getUrl } = useContext(context) as Context;
