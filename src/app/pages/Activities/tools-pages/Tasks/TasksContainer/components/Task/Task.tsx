...
function Task(props: TaskProps) {
    ...
    const { darkMode, setSelectedTaskClass, setAllowChanges, setShowAssistant, setModifyData, userInfo, setWeekData, setAnalytics } = useContext(context) as Context;
            ...
            action: "Pending", functionCall: () => {
                if (isRealTask) {
                    return updateTask({
                        ...
                        task, groupId: group.groupId, userId: userInfo?.userId, setAnalytics
                    })
                }
            ...
            action: "Finished", functionCall: () => {
                if (isRealTask) {
                    return updateTask({
                        ...
                        task, groupId: group.groupId, userId: userInfo?.userId, setWeekData, setAnalytics
                    })
                }
