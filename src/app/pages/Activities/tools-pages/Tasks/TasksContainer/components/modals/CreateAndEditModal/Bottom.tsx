...
export default function Bottom(props: CEMBottomProps): JSX.Element {
    ...
    const { setSelectedTaskClass, setAllowChanges, userInfo, setAnalytics, setWeekData } = useContext(context) as Context;
                ...
                clickListener={() => {
                    ...
                    if (propsForCEM.modalFor == "group") {
                        updateGroup({
                            ...
                            userId: userInfo?.userId, setAnalytics, setWeekData
                        })
                        setChangedValue("");
                        ...
                        addTask({
                            ...
                            userId: userInfo?.userId, setSelectedTaskClass, setAllowChanges, setAnalytics
                        })
                        setChangedValue("");
                        setCreateAndEditModal(false);
                        return setPropsForCEM(null);
