...
declare global {
    ...
    type PropsForDTGB = {
        showDTGB: boolean,
        setShowDTGB: Dispatch<SetStateAction<boolean>>,
        group?: TaskGroup
    }
}
...
declare global {
    ...
    type TaskGroupProps = {
        ...
        showDTGB: boolean,
        setShowDTGB: Dispatch<SetStateAction<boolean>>,
        setPropsForDTGB: Dispatch<SetStateAction<PropsForDTGB>>,
...
declare global {
    type TaskContainerValues = {
        ...
        showDTGB: boolean, setShowDTGB: Dispatch<SetStateAction<boolean>>,
        // NUMBERS
        // OBJECTS AND ARRAYS
        pseudoGroup: PseudoGroup, setPseudoGroup: Dispatch<SetStateAction<PseudoGroup>>,
        pseudoTasks: PseudoTasks, setPseudoTasks: Dispatch<SetStateAction<PseudoTasks>>,
        propsForCEM: PropsForCEM, setPropsForCEM: Dispatch<SetStateAction<PropsForCEM>>,
        propsForDTGB: PropsForDTGB, setPropsForDTGB: Dispatch<SetStateAction<PropsForDTGB>>,
    }
