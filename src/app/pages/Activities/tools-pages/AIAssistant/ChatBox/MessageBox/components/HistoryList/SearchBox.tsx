...
function ConvoList({ showConvoLists, setShowConvoLists, chatBotValues, setIsConvoLoading }: { showConvoLists: boolean, setShowConvoLists: Dispatch<SetStateAction<boolean>>, setIsConvoLoading: Dispatch<SetStateAction<boolean>>, chatBotValues: ChatBotValues }) {
                        ...
                        results.length != 0
                            ? results.map(convo =>
                                <Result 
                                    ...
                                    setIsConvoLoading={setIsConvoLoading} />
                            )
